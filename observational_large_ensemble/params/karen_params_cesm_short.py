...
valid_years = np.arange(1966, 2006)  # Only use 40 years of data for analog with satellite era
...
workdir_base = '/glade/work/mckinnon/obsLE/parameters_v-short'
output_dir = '/glade/scratch/mckinnon/obsLE/output_v-short'
